...
`
    ...
    function UpdateSection() {
      ...
      function onCheck() {
        ...
        post('/check').then(function (answered) {
          setBusy(null)
          if (answered.ok) setStatus(answered.body)
          else setNote(String(answered.body.message || '检测失败'))
        })
      }
      ...
      if (status !== null) {
        ...
        if (isGit) {
          ...
          facts.push(['当前提交', shortSha(status.localHead)])
          facts.push(['上游提交', shortSha(status.remoteHead)])
